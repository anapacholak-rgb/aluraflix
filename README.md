...
Feito por Guilherme Silveira, instrutor e fundador da Alura.
  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "exibir a quantidade de figurinhas que João recebeu."  "nbformat": 4,
  "nbformat_minor": 0,
  "metadata": {
    "colab": {
      "provenance": []
    ...
    "kernelspec": {
      "name": "python3",
      "display_name": "Python 3"  "nbformat": 4,
  "nbformat_minor": 0,
  "metadata": {
    "colab": {
      "provenance": []
  ...
  "metadata": {
    ...
    "language_info": {
      "name": "python" Como alternativa, use escpara tabmover para o próximo elemento interativo na página.
